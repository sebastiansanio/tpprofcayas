...
<section id="edit-customsBroker" class="first">
	...
	<g:form method="post" class="form-horizontal" >
		<g:hiddenField name="id" value="${customsBrokerInstance?.id}" />
		<g:hiddenField name="version" value="${customsBrokerInstance?.version}" />
		<fieldset class="form">
