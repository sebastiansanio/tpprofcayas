...
<div class="row-fluid">
	...
	<div class="span7">
			...
			<div class="control-group fieldcontain ${hasErrors(bean: alertMessageInstance, field: 'subject', 'error')} required">
				...
				<div class="controls">
					<g:textField class="span12" name="subject" required="" value="${alertMessageInstance?.subject}"/>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: alertMessageInstance, field: 'message', 'error')} required">
				...
				<div class="controls">
					<g:textArea class="span12" cols="60" rows="7" name="message" required="" value="${alertMessageInstance?.message}"/>
	...
	<div class="span4">
		...
		<p>	<g:message code="transformText.header.message" default="n subject and body you can use the following variables:" /></p>
		...
		<p>	<g:message code="transformText.variable.signature.message" default="[signature] = Signature" /></p>
