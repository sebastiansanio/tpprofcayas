<%@ page import="stakeholder.Contact" %>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: contactInstance, field: 'stakeholder', 'error')} required">
				...
				<div class="controls">
					<g:select id="stakeholder" name="stakeholder.id" from="${stakeholder.Stakeholder.list(sort:'name')}" optionKey="id" required="" value="${contactInstance?.stakeholder?.id}" class="many-to-one"/>
