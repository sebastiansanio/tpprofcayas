...
<section id="edit-customerPriceCriteria" class="first">
	...
	<g:form method="post" class="form-horizontal" >
		<g:hiddenField name="id" value="${customerPriceCriteriaInstance?.id}" />
		<g:hiddenField name="version" value="${customerPriceCriteriaInstance?.version}" />
		<fieldset class="form">
