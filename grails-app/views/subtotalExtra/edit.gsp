...
<section id="edit-subtotalExtra" class="first">
	...
	<g:form method="post" class="form-horizontal" >
		<g:hiddenField name="id" value="${subtotalExtraInstance?.id}" />
		<g:hiddenField name="version" value="${subtotalExtraInstance?.version}" />
		<fieldset class="form">
