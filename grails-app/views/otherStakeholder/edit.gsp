...
<section id="edit-otherStakeholder" class="first">
	...
	<g:form method="post" class="form-horizontal" >
		<g:hiddenField name="id" value="${otherStakeholderInstance?.id}" />
		<g:hiddenField name="version" value="${otherStakeholderInstance?.version}" />
		<fieldset class="form">
