...
class BootStrap {
    ...
    def init = { servletContext ->
    	...
    	alertType.save()
		alertType = new AlertType(description:"Enviar diseño de caja",nameOfEstimatedDateField:"wishDate",nameOfCompletionField:"cartonsPrintingInfoSentDate",alertTerm:0,frequency:3)
		alertType.save()
