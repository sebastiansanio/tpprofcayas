...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		roleManager.addToPermissions("criterionValue:*")
		roleManager.addToPermissions("currency:*")
		roleManager.addToPermissions("documentType:*")
		roleManager.addToPermissions("shippingMark:*")
		roleManager.addToPermissions("typeOfFreight:*")
		roleManager.save()
