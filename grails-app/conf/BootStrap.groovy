...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		alertType.save()
		alertType = new AlertType(description:"Confirmar fecha de delivery",nameOfEstimatedDateField:"deliveryDate",nameOfCompletionField:"confirmedDeliveryDate",alertTerm:20,frequency:10)
		alertType.save()
		...
		alertType.save()
		alertType = new AlertType(description:"Pedir fotos del container",nameOfEstimatedDateField:"estimatedPicturesOfLoadingContainerReceivedDate",nameOfCompletionField:"picturesOfLoadingContainerReceived",alertTerm:0)
		alertType.save()
