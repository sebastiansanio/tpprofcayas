...
<section id="edit-alertMessage" class="first">
	...
	<g:form method="post" class="form-horizontal" >
		<g:hiddenField name="id" value="${alertMessageInstance?.id}" />
		<g:hiddenField name="version" value="${alertMessageInstance?.version}" />
		<fieldset class="form">
