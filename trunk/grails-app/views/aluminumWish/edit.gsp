...
<section id="edit-aluminumWish" class="first">
	...
	<g:form method="post" class="form-horizontal" >
		<g:hiddenField name="id" value="${aluminumWishInstance?.id}" />
		<g:hiddenField name="version" value="${aluminumWishInstance?.version}" />
		<fieldset class="form">
