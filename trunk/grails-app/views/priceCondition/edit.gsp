...
<section id="edit-priceCondition" class="first">
	...
	<g:form method="post" class="form-horizontal" >
		<g:hiddenField name="id" value="${priceConditionInstance?.id}" />
		<g:hiddenField name="version" value="${priceConditionInstance?.version}" />
		<fieldset class="form">
